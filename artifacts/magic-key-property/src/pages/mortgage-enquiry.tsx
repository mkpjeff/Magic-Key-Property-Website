    ...
    <Layout>
      ...
      <section className="form-hero w-full">
        ...
        <div className="container mx-auto px-4 py-10 md:py-14 max-w-3xl relative z-10">
          ...
          <div className="badge-pill mb-4">Mortgage Advice</div>
          <h1 className="text-3xl md:text-4xl font-serif font-bold text-white mb-3 leading-tight">
            Mortgage Advice Enquiry
          </h1>
          <p className="text-gray-400">Complete the form below to discover your mortgage options.</p>
        </div>
      </section>
        ...
        {submitted ? (
          <div className="form-success-card">
            ...
            <p className="text-gray-500 max-w-md mx-auto mb-8">
              Thank you for your Mortgage Advice enquiry. Our advisory team will review your details and be in touch shortly.
            </p>
            <Link href="/">
                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                    ...
                    <div className="space-y-6 pt-4">
                      <h3 className="form-section-heading">Mortgage Requirements</h3>
