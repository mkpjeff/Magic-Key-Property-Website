        ...
        {submitted ? (
          ...
          <>
            <div className="mb-8">
              ...
              <h1 className="text-3xl font-serif font-bold text-foreground mb-3">Tax, Accounting & Company Formation</h1>
              <p className="text-muted-foreground">Complete the form below to receive professional tax and accounting advice.</p>
            </div>
